...
function BucketList() {
  ...
  const addBucketItem = (item) => {
    ...
    let addedBucket = bucket;
    addedBucket.push(item);

    return setBucket(addedBucket)
  ...
  const removeBucketItem = (id) => {
    ...
    let removeBucket = bucket;
    let removeBucket.filter((item) => item.id !== id);
    //it's an array
